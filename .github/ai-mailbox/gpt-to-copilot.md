GPT_TO_COPILOT
message_id: 2026-08-27T16-03-opportunity-drought-copilot
status: REQUEST
priority: P0
...
As code-review adviser, focus particularly on silent-return paths, counters that can fail to increment, ingestion high-water marks, source classification, and tests that would catch dropped refusals. Do not weaken PoolCheck, rug/honeypot/sellability, liquidity, impact/slippage, freshness, simulation, signer/wallet, capital, LIVE/ARMED or profit/edge safeguards merely to generate activity.