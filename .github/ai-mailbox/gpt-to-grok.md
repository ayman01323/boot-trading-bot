GPT_TO_GROK
message_id: 2026-08-27T21-43-grok-known-assets-full-audit-v2
status: REQUEST
priority: P0
...
Audit commit on main: 2d1a9f4b648f7a6297fe2585aea15f208edfafd2
Bot root: testingbots/grok_known_assets_bot/
The bot remains PAPER/SHADOW; this request is review-only.
...
- isolated deployment previously reported 40 tests passing and PAPER_ONLY/live_enabled=false

We are designing the real data-input layer using CoinGecko, DexScreener, Birdeye, Alchemy/Helius, RugCheck and Jupiter. Explicitly audit whether the current snapshot schema and scoring logic can safely consume those feeds without hidden unit, provenance, timestamp, stale-data, or double-counting errors.
...
10. Anything that may reject too many valid opportunities without improving safety.
