...
# Stop the redundant hourly VPS GPT call; deterministic audit/control continues and Strategy Lab handles gated paid AI.
from . import server_gpt_cost_saver_patch  # noqa: F401
