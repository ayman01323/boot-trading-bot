...
TEST_ALERT_VERSION = "simo-good-moring-test-v5"
...
def send_target_test_once(app) -> dict:
    ...
    if len(recipients) < MIN_TARGET_TEST_RECIPIENTS:
        warning = (
            ...
            "SiMo Good Moring will be sent when all three recipients are available."
        )
    ...
    result = send_to_chats(app.telegram_bot_token, recipients, "SiMo Good Moring")
