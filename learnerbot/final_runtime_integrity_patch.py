...
def composition_checks() -> dict[str, bool]:
    ...
    return {
        # Solana execution/safety stack. These are the capital-moving identities.
        ...
        # Intended late Solana composition: verified-capacity -> recovery reconcile
        # -> durable LIQUIDITY_STUCK nonblocking. Same-mint/exposure truth remains.
        ...
        # EVM Alchemy history queue. Legacy migration must stay outermost so an
        # always-busy ranked/progress queue cannot starve orphaned Etherscan rows.
        ...
        # Immutable per-trade provenance must remain attached after all history
        # and reporting patches have loaded.
