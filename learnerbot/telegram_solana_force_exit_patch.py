...
# live-web enables fresh public lookups only when the final PasPuss answer needs them;
...
from . import ai_council_live_web_patch as _ai_council_live_web  # noqa: E402,F401
