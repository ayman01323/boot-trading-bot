...
# re-quote that can only notify, never close/resize/execute. See
# solana_position_liquidity_health_patch.py for the rationale.
...
def install():
    ...
    checks = {
        ...
        "solana_monitor_reconciliation_outer": _sol.monitor_positions is _liquidity_health.monitor_positions_with_liquidity_health,
        "solana_monitor_liquidity_health_inner": _liquidity_health._PREV_MONITOR_POSITIONS is _exit_circuit._monitor_with_exit_reconciliation,
