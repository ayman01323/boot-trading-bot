...
def main(argv: list[str] | None = None) -> int:
    ...
    journal.event("PAPER_RUNNER_START", None, {"supported_assets": [asset.key for asset in supported], "unsupported_enabled_assets": unsupported, "poll_seconds": feed.settings.poll_seconds, "paper": True, "feed": "real"})
    print(json.dumps({"status": "STARTED", "mode": "PAPER", "feed": "REAL_PUBLIC", "supported_assets": [asset.key for asset in supported], "unsupported_enabled_assets": unsupported, "poll_seconds": feed.settings.poll_seconds}), flush=True)
