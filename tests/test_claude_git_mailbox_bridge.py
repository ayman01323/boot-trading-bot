...
def test_normalize_routes_persistent_claude_only_to_gpt() -> None:
...
def test_api_and_persistent_mailbox_paths_are_distinct() -> None:
    assert bridge.CLAUDE_API_TO_GPT_PATH != bridge.CLAUDE_TO_GPT_PATH
